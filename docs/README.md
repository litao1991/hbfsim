...
本目录记录 HBFSim v0.8.2 的架构、模型语义和实验方法。文档以当前代码实现为准。
...
- [V0.8_SPEC_CONTROL_PLANE.md](V0.8_SPEC_CONTROL_PLANE.md)：R1–R5 Block Replay、Simulator API 寄存器基础和 Spec Zone Remap 控制面。
...
- [V0.7_SEMANTIC_CONVERGENCE.md](V0.7_SEMANTIC_CONVERGENCE.md)：Host Rewrite 原因分离、Page retention、Zone/Wear v2、映射契约与执行边界。
